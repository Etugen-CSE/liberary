...
//     $cate_query = "INSERT INTO categories( name, description,) VALUES('$name', '$description')";
//     $cate_query_run = mysqli_query($con, $cate_query);
//     if ($cate_query_run) {
//         redirect("admin-add-category.php", "Амжилттай нэмлээ");
//     } else {
//         redirect("admin-add-category.php", "ямар нэг зүйл буруу гарлаа, дахин оролдоно уу");
//     }
// }
