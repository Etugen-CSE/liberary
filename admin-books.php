...
if (isset($_POST['delete_book_btn'])) {
   ...
   $book_query_run = mysqli_query($conn, $book_query);
   $book_data = mysqli_fetch_array($book_query_run);
   ...
   if ($delete_query_run) {
      ...
      redirect('admin-books.php', "Амжилттай устгалаа ");
   } else {
      redirect('admin-books.php', "Алдаа гарлаа");
   }
}
?>
?>
...
<!-- Mirrored from iqonic.design/themes/booksto/php/admin-books.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:20 GMT -->
         ...
         <div class="iq-navbar-custom">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
               ...
               <div class="navbar-breadcrumb">
                  <h5 class="mb-0">номнууд</h5>
                  <nav aria-label="breadcrumb">
                     <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index-2.php">Админ</a></li>
                        <li class="breadcrumb-item active" aria-current="page">номнууд</li>
                     </ul>
                  </nav>
               </div>
                  ...
                  <ul class="navbar-nav ml-auto navbar-list">
                     ...
                     <li class="line-height pt-3">
                        <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                           ...
                           <div class="caption">
                              <h6 class="mb-1 line-height">lkhagva</h6>
                  ...
                  <div class="iq-card">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">Номын жагсаалт</h4>
                        </div>
                        <div class="iq-card-header-toolbar d-flex align-items-center">
                           <a href="admin-add-book.php" class="btn btn-primary">шинэ ном нэмэх</a>
                        </div>
                     </div>
                     <div class="iq-card-body">
                           ...
                           <table class="data-tables table table-striped table-bordered" style="width:100%">
                              <thead>
                                 <tr>
                                    ...
                                    <th style="width: 12%;">ном зураг</th>
                                    <th style="width: 15%;">ном нэр</th>
                                    <th style="width: 15%;">Ном төрөл</th>
                                    <th style="width: 15%;">Ном зохиолч</th>
                                    <th style="width: 18%;">Ном тайлбар</th>
                                    <th style="width: 7%;">боломж</th>
                              ...
                              <tbody>
                                 ...
                                 ?>
                                       <tr>
                                          <td> <?= $item['id']; ?></td>
                                          <td>
                                             <img src="uploads/<?= $item['image'] ?>" class="img-fluid avatar-50 rounded" alt="">
                                          </td>
                                          <td><?= $item['b_name']; ?></td>
                                          <td>
                                             <?= $item['c_name']; ?>
                                          ...
                                          <td><?= $item['possible']; ?></td>
                                          <td>
                                             <a href="book-pdf.html"><i class="ri-file-fill text-secondary font-size-18"></i></a>
                                          </td>
                                          <td>
                                             <div class="flex align-items-center list-user-action">
                                                <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="admin-update-book.php?id=<?= $item['id']; ?>"><i class="ri-pencil-line"></i></a>
                                                <form action="admin-books.php" method="POST">
                                                   <input type="hidden" name="book_id" value="<?= $item['id']; ?>">
                                                   <!-- <a class=""  href="#"></a> -->
                                                   <button type="submit" class="bg-primary" name="delete_book_btn" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="ri-delete-bin-line"></i></button>
                                                </form>
                                             </div>
                                          </td>
                                       </tr>
...
<!-- Mirrored from iqonic.design/themes/booksto/php/admin-books.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:21 GMT -->
