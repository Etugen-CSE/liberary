...
if (isset($_POST['update_category_btn'])) {
    ...
    $update_query = "UPDATE categories SET name='$name',description='$description' WHERE id='$category_id'";
    $update_query_run = mysqli_query($conn, $update_query);
    if ($update_query_run) {
        $_SESSION['message'] = "shinclee";
        header('Location: admin-update-category.php?id=' . $category_id);
    } else {
        $_SESSION['message'] = "aldaa garlaa";
        header('Location: admin-update-category.php?id=' . $category_id);
    }
}
?>
...
<!-- Mirrored from iqonic.design/themes/booksto/php/admin-add-category.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:57:01 GMT -->
                    ...
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        <li>
                            ...
                            <ul id="dashboard" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                ...
                                <li><a href="category.php"><i class="ri-function-line"></i>омын төрөл</a></li>
                                <li><a href="book-page.php"><i class="ri-book-line"></i>номын </a></li>
                        ...
                        <li class="active active-menu">
                            <a href="#admin" class="iq-waves-effect" data-toggle="collapse" aria-expanded="true"><span class="ripple rippleEffect"></span><i class="las la-home iq-arrow-left"></i><span>Админ
                                </span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                            <ul id="admin" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">

                                <li class="active"><a href="admin-category.php"><i class="ri-function-line"></i>Ном
                                        төрөл</a></li>
            ...
            <div class="iq-navbar-custom">
                <nav class="navbar navbar-expand-lg navbar-light p-0">
                    ...
                    <div class="navbar-breadcrumb">
                        <h4 class="mb-0 text-dark">төрөл нээмх</h4>
                        <p class="mb-0"><span class="text-primary">Сайн байна уу,</span>төрөл нэмэх</p>
                    </div>
                                ...
                                <div class="iq-card">
                                    <div class="iq-card-header d-flex justify-content-between">
                                        <div class="iq-header-title">
                                            <h4 class="card-title">Төрөл нэмэх</h4>
                                        </div>
                                    </div>
                                    <div class="iq-card-body">
                                        <form action="admin-add-category.php" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <input type="hidden" name="category_id" value="<?= $data['id'] ?> ">
                                                <label>төрөл нэр:</label>
                                                <input type="text" name="c_name" value="<?= $data['c_name'] ?>" class=" form-control">
                                            </div>
                                            <div class="form-group">
                                                <label>төрөл тайлбар:</label>
                                                <textarea class="form-control" name="description" rows="4"><?= $data['description'] ?></textarea>
                                            </div>
                                            <button type="submit" name="update_category_btn" class="btn btn-primary">шинэчлэх</button>
                                            <button type="reset" class="btn btn-danger">дахин боловсруулах</button>
                                        </form>
                                    </div>
                                </div>
                        <?php
