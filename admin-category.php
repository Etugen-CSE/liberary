...
<!-- Mirrored from iqonic.design/themes/booksto/php/admin-category.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:16 GMT -->
         ...
         <div class="iq-navbar-custom">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
               ...
               <div class="navbar-breadcrumb">
                  <h5 class="mb-0">Төрөл жагсаалт</h5>
                  <nav aria-label="breadcrumb">
                     <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index-2.php">Админ</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Төрөл жагсаалт</li>
                     </ul>
                  </nav>
               </div>
                  ...
                  <ul class="navbar-nav ml-auto navbar-list">
                     ...
                     <li class="line-height pt-3">
                        <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                           ...
                           <div class="caption">
                              <h6 class="mb-1 line-height">Lkahgva</h6>
                  ...
                  <div class="iq-card">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">Төрөл жагсаалт</h4>
                        </div>
                        <div class="iq-card-header-toolbar d-flex align-items-center">
                           <a href="admin-add-category.php" class="btn btn-primary">шинэ төрөл нэмэх</a>
                        </div>
                     </div>
                     <div class="iq-card-body">
                        <div class="table-responsive">
                           <table class="data-tables table table-striped table-bordered" style="width:100%">
                              <thead>
                                 <tr>
                                    <th width="5%">No</th>
                                    <th width="20%">Төрөл нэр</th>
                                    <th width="65%">Төрөл тайлбар</th>
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             <div class="flex align-items-center list-user-action">
                                                <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="admin-update-category.php?id=<?= $item['id']; ?>"><i class="ri-pencil-line"></i></a>
                                                <form action="admin-category.php" method="POST">
                                                   <input type="hidden" name="category_id" value="<?= $item['id']; ?>">
                                                   <!-- <a class=""  href="#"></a> -->
                                                   <button type="submit" class="bg-primary" name="delete_category_btn" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="ri-delete-bin-line"></i></button>
                                                </form>
...
<!-- Mirrored from iqonic.design/themes/booksto/php/admin-category.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:19 GMT -->
