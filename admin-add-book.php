...
if (isset($_POST['add_book_btn'])) {
   ...
   $book_query = "INSERT INTO book(c_name,a_name, b_name, description,possible,pdf,image) 
   VALUES('$c_name','$a_name','$name', '$description','$possible','$filename','$filename')";
...
<!-- Mirrored from iqonic.design/themes/booksto/php/admin-add-book.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:57:01 GMT -->
         ...
         <div class="iq-navbar-custom">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
               ...
               <div class="navbar-breadcrumb">
                  <h4 class="mb-0 text-dark">Ном нэмэх</h4>
                  <p class="mb-0"><span class="text-primary">Сайн байна уу,</span>Ном нэмэх</p>
               </div>
                  ...
                  <div class="iq-card">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">Ном нэмэх</h4>
                        </div>
                     </div>
                     <div class="iq-card-body">
                        <form action="admin-add-book.php" method="POST" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                              <label>ном зохиолч:</label>
                              <select name="a_name" class="form-select">
                                 <option selected>Зохиолч сонгох</option>
                                 <?php
                                 ...
                                 <?php
                                    ...
                                    echo "зохиолч байхгүй байна";
                                 }
                                 ?>
                              </select>
                           </div>
                           <div class="form-group">
                              <label>Ном зураг:</label>
                           ...
                           <div class="form-group">
                              <label>ном зээлэх:</label>
                              <input type="text" name="possible" class="form-control">
                           </div>
                           <div class="form-group">
                              <label>ном тайлбар:</label>
                              <textarea class="form-control" name="description" rows="4"></textarea>
                           </div>
                           <button type="submit" name="add_book_btn" class="btn btn-primary">нэмэх</button>
                           <button type="reset" class="btn btn-danger">дахин шинэчлэх</button>
                        </form>
                     </div>
                  </div>
               </div>
