...
if (isset($_POST['update_author_btn'])) {
    ...
    $path = "../uploads";
    $update_query = "UPDATE author SET name='$name',description='$description',email='$email',image='$update_filename' WHERE id='$author_id'";
    ...
    if ($update_query_run) {
        ...
        header('Location: admin-update-author.php?id=' . $author_id);
    } else {
                                    ...
                                    <div class="iq-card-body">
                                        <form action="admin-add-author.php" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="a_name" value="<?= $data['a_name'] ?>" class=" form-control">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <img src="uploads/<?= $data['image'] ?>" height="0px" width="0px" alt="бүтээгдэхүүний зураг">
                                            ...
                                            <button type="submit" name="update_author_btn" class="btn btn-primary">нэмэх</button>
