...
<!-- Mirrored from iqonic.design/themes/booksto/php/Checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:11 GMT -->
               ...
               <div class="navbar-breadcrumb">
                  ...
                  <nav aria-label="breadcrumb">
                     <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">түрээслэх</li>
                     </ul>
                  </nav>
               </div>
                           ...
                           <div class="iq-card-body">
                              <form onsubmit="required()">
                                 <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                       <button id="savenddeliver" type="submit" class="btn btn-primary">Save And Deliver
                                          Here</button>
                                    </div>
                                 </div>
                              </form>
                     ...
                     <div class="col-lg-8">
                        <div class="iq-card">
                           ...
                           <div class="iq-card-body">
                              ...
                              <hr>
                              <div class="add-card">
                                 <a href="#"><span><i class="ri-add-box-line mr-2 font-size-18"></i>Add Gift
                                       Card</span></a>
                              </div>
                           </div>
                        </div>
...
<!-- Mirrored from iqonic.design/themes/booksto/php/Checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 03:55:16 GMT -->
