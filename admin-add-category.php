...
if (isset($_POST['add_category_btn'])) {
   ...
   $cate_query = "INSERT INTO categories( c_name, description,created_at) VALUES('$name', '$description',now())";
                  ...
                  <div class="iq-card">
                     ...
                     <div class="iq-card-body">
                        <form action="admin-add-category.php" method="POST" enctype="multipart/form-data">
                           ...
                           <button type="submit" name="add_category_btn" class="btn btn-primary">нэмэх</button>
